export default class ProcessTableData {
  ...
  setIndicators(type, period, magnitude) {
    this.type = type;
    this.period = period;
    this.magnitude = magnitude;
  }
  ...
  processIndicators() {
    if (this.type === 'cases' && this.period === 'total' && this.magnitude === 'absolute') this.indicator = 'cases';
    if (this.type === 'cases' && this.period === 'today' && this.magnitude === 'absolute') this.indicator = 'todayCases';
    if (this.type === 'cases' && this.period === 'total' && this.magnitude === 'per 100 thousand') this.indicator = 'casesPerOneMillion';
